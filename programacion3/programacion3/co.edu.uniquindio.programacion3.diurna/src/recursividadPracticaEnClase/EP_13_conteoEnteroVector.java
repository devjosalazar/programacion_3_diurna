...
public class EP_13_conteoEnteroVector {
	...
	/**
	1.	Dado un vector de n enteros, el problema a resolver recursivamente consiste en contar el número de veces que un valor dado aparece en dicho vector: 
	Parámetros
	...
	•	Identificar el caso de recursión.
	**/
